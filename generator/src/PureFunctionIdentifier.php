...
final class PureFunctionIdentifier
{
    private const IMPURE_FUNCTION_LIST = [
        // file io
    ...
    public static function isFunctionPure(string $functionName): bool
    {
        if (in_array(strtolower($functionName), self::IMPURE_FUNCTION_LIST, true)) {
            return false;
        }

        if (str_starts_with($functionName, 'image')) {
            return false;
        }
